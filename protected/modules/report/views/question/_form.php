...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="row page_id">
		<?php echo CHtml::activeLabelEx($model,'page_id'); ?>
		<?php echo (($model->id)?CHtml::activeTextField($model,'page_id',array('readonly'=>true)):CHtml::activeTextField($model,'page_id')); ?>
		<?php echo CHtml::error($model,'page_id'); ?>
		<p class="hint"><?php echo UserModule::t('page question belongs to'); ?></p>
	</div>
	...
	<div class="row field_type">
		...
		<?php /*echo (($model->id)?CHtml::activeTextField($model,'field_type',array('size'=>60,'maxlength'=>50,'readonly'=>true,'id'=>'field_type')):CHtml::activeDropDownList($model,'field_type',Question::itemAlias('field_type'),array('id'=>'field_type'))); */?>
<?php echo (CHtml::activeDropDownList($model,'field_type',Question::itemAlias('field_type'),array('id'=>'field_type'))); ?>
	...
	<div class="row required">
		...
		<?php echo CHtml::activeDropDownList($model,'required',Question::itemAlias('required')); ?>
	...
	<div class="row widget">
		...
		<?php 
		list($widgetsList) = QuestionController::getWidgets($model->field_type);
	...
	<div class="row visible">
		...
		<?php echo CHtml::activeDropDownList($model,'visible',Question::itemAlias('visible')); ?>
		<?php echo CHtml::error($model,'visible'); ?>
	</div>
	<div class="row helpText">
		<?php echo CHtml::activeLabelEx($model,'helpText'); ?>
		<?php echo CHtml::activeTextField($model,'helpText',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo CHtml::error($model,'helpText'); ?>
	</div>
	<div class="row css">
		<?php echo CHtml::activeLabelEx($model,'css'); ?>
		<?php echo CHtml::activeTextField($model,'css',array('size'=>60,)); ?>
		<?php echo CHtml::error($model,'css'); ?>
	</div>
	<div class="row ">
		<?php echo CHtml::activeLabelEx($model,'choicesView'); ?>
		<?php echo CHtml::activeTextField($model,'choicesView',array('size'=>60,)); ?>
		<?php echo CHtml::error($model,'choicesView'); ?>
	</div>
	
	
	<div class="row buttons">
		<?php 
		$url ='index.php?r=report/question/update&id='.$model->id;
		if($model->isNewRecord)
		{ $url ='index.php?r=report/question/create&id='.$model->id.'&pageid='.$model->page_id;}
